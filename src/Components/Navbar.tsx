            ...
            <div className="container">
                ...
                <div className='flex items-center justify-between py-4'>
                    ...
                    <div className='hidden md:flex items-center gap-4'>
                        ...
                        <div className='md:hidden  bg-mainColor py-3 px-5 rounded-lg text-white lg:flex items-center gap-2'><FaPhoneAlt /> <span className='font-medium text-base'>+998951575050</span></div>
                    </div>
